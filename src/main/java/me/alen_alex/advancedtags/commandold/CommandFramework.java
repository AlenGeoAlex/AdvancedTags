...
public abstract class CommandFramework extends Command {
    ...
    protected CommandHandler_ handler;
    private HashMap<String,Subcommand> subcommands;

    public CommandFramework(@NotNull String name, @NotNull String commandPermission, @NotNull CommandHandler_ handler) {
        super(name);
    ...
    public CommandFramework(@NotNull String name, @NotNull String commandPermission, @NotNull CommandHandler_ handler, Subcommand... subcommand) {
        super(name);
        this.commandName = name;
        this.commandPermission = commandPermission;
        this.handler = handler;
    ...
    public CommandHandler_ getHandler() {
        return handler;
    }
}
